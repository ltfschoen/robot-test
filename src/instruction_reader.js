...
InstructionReader.prototype.processCommands = function(table, toyRobot, instructions) {
...
InstructionReader.prototype.readInstructionFile = function(table, toyRobot, filename, callback) {
