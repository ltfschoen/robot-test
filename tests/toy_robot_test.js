...
describe("ToyRobot", function() {
    describe('WithNoPlaceInitially', function () {
    ...
    describe('WithInvalidPlaceOrFacingDirection', function () {
    ...
    describe('WithValidPlaceAndFacingDirection', function () {
        describe('WithoutValidMove', function() {
        ...
        describe('WithValidMove', function () {
        ...
        describe('WithValidRotate', function() {
